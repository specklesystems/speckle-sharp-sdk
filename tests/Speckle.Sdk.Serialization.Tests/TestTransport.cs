...
public class TestTransport : ITransport
{
  ...
  public Task SaveObject(string id, ITransport sourceTransport) => throw new NotImplementedException();

  public Task WriteComplete() => throw new NotImplementedException();

  public Task<string?> GetObject(string id) => Task.FromResult<string?>(Objects.TryGetValue(id, out string? o) ? o : null);
