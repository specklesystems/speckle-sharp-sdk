...
[MemberData(nameof(SmallTestCasesMd5))]
  public void Md5(string input, string _, string expected,
 int length
  )
  {
  ...
  public void Sha256_Span(string input, string expected, string _ , int length //Span version of the function must have multiple of 2
  )
  {
