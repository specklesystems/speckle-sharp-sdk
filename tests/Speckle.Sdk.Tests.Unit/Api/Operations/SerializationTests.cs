...
public class ObjectSerialization
{
  ...
  public async Task SimpleSerialization()
  {
    ...
    var result = Sdk.Api.Operations.Operations.Serialize(table);
    var test = await Sdk.Api.Operations.Operations.Deserialize(result);
    ...
    var strPoly = Sdk.Api.Operations.Operations.Serialize(polyline);
    var dePoly = await Sdk.Api.Operations.Operations.Deserialize(strPoly);
  ...
  public async Task IgnoreCircularReferences()
  {
    ...
    var test = Sdk.Api.Operations.Operations.Serialize(pt);

    var result = await Sdk.Api.Operations.Operations.Deserialize(test);
  ...
  public async Task InterfacePropHandling()
  {
    ...
    var result = Sdk.Api.Operations.Operations.Serialize(cat);

    var deserialisedFeline = await Sdk.Api.Operations.Operations.Deserialize(result);
  ...
  public async Task InheritanceTests()
  {
    ...
    var str = Sdk.Api.Operations.Operations.Serialize(superPoint);
    var sstr = await Sdk.Api.Operations.Operations.Deserialize(str);
  ...
  public async Task ListDynamicProp()
  {
    ...
    var str = Sdk.Api.Operations.Operations.Serialize(point);
    var dsrls = await Sdk.Api.Operations.Operations.Deserialize(str);
  ...
  public async Task ChunkSerialisation()
  {
    ...
    var baseChunkString = Sdk.Api.Operations.Operations.Serialize(baseBasedChunk);
    var stringChunkString = Sdk.Api.Operations.Operations.Serialize(stringBasedChunk);
    var doubleChunkString = Sdk.Api.Operations.Operations.Serialize(doubleBasedChunk);

    var baseChunkDeserialised = (DataChunk)await Sdk.Api.Operations.Operations.Deserialize(baseChunkString);
    var stringChunkDeserialised = (DataChunk)await Sdk.Api.Operations.Operations.Deserialize(stringChunkString);
    var doubleChunkDeserialised = (DataChunk)await Sdk.Api.Operations.Operations.Deserialize(doubleChunkString);
  ...
  public async Task ObjectWithChunksSerialisation()
  {
    ...
    var serialised = Sdk.Api.Operations.Operations.Serialize(mesh);
    var deserialised = await Sdk.Api.Operations.Operations.Deserialize(serialised);
  ...
  public void EmptyListSerialisationTests()
  {
    ...
    var serialised = Sdk.Api.Operations.Operations.Serialize(test);
    var isCorrect =
  ...
  public async Task DateSerialisation()
  {
    ...
    var result = Sdk.Api.Operations.Operations.Serialize(mockBase);
    var test = (DateMock)await Sdk.Api.Operations.Operations.Deserialize(result);
  ...
  public async Task GuidSerialisation()
  {
    ...
    var result = Sdk.Api.Operations.Operations.Serialize(mockBase);
    var test = (GUIDMock)await Sdk.Api.Operations.Operations.Deserialize(result);
  ...
  public async Task ColorSerialisation()
  {
    ...
    var result = Sdk.Api.Operations.Operations.Serialize(mockBase);
    var test = (ColorMock)await Sdk.Api.Operations.Operations.Deserialize(result);
  ...
  public async Task StringDateTimeRegression()
  {
    ...
    var result = Sdk.Api.Operations.Operations.Serialize(mockBase);
    var test = (StringDateTimeRegressionMock)await Sdk.Api.Operations.Operations.Deserialize(result);
