...
public class ObjectSerialization2
{
  ...
  {
    TypeLoader.Reset();
    TypeLoader.Initialize(typeof(Base).Assembly, typeof(DataChunk).Assembly, typeof(ColorMock2).Assembly);
  ...
  public async Task IgnoreCircularReferences()
  {
    ...
    var test = _operations.Serialize2(pt);
  ...
  public async Task InterfacePropHandling()
  {
    ...
    var result = _operations.Serialize2(cat);
  ...
  public async Task InheritanceTests()
  {
    ...
    var str = _operations.Serialize2(superPoint);
  ...
  public async Task ListDynamicProp()
  {
    ...
    var str = _operations.Serialize2(point);
  ...
  public async Task ChunkSerialisation()
  {
    ...
    var baseChunkString = _operations.Serialize2(baseBasedChunk);
    var stringChunkString = _operations.Serialize2(stringBasedChunk);
    var doubleChunkString = _operations.Serialize2(doubleBasedChunk);
  ...
  public async Task ObjectWithChunksSerialisation()
  {
    ...
    var serialised = _operations.Serialize2(mesh);
  ...
  public void EmptyListSerialisationTests()
  {
    ...
    var serialised = _operations.Serialize2(test);
    var isCorrect =
  ...
  [SpeckleType("Speckle.Core.Tests.Unit.Api.Operations.ObjectSerialization+DateMock2")]
  private class DateMock2 : Base
  {
  ...
  public async Task DateSerialisation()
  {
    ...
    var mockBase = new DateMock2 { TestField = date };

    var result = _operations.Serialize2(mockBase);
    var test = (DateMock2)await _operations.DeserializeAsync(result);

    Assert.That(test.TestField, Is.EqualTo(date));
  }

  [SpeckleType("Speckle.Core.Tests.Unit.Api.Operations.ObjectSerialization+GUIDMock2")]
  private class GUIDMock2 : Base
  {
  ...
  public async Task GuidSerialisation()
  {
    ...
    var mockBase = new GUIDMock2 { TestField = guid };

    var result = _operations.Serialize2(mockBase);
    var test = (GUIDMock2)await _operations.DeserializeAsync(result);

    Assert.That(test.TestField, Is.EqualTo(guid));
  }

  [SpeckleType("Speckle.Core.Tests.Unit.Api.Operations.ObjectSerialization+ColorMock2")]
  private class ColorMock2 : Base
  {
  ...
  public async Task ColorSerialisation()
  {
    ...
    var mockBase = new ColorMock2 { TestField = color };

    var result = _operations.Serialize2(mockBase);
    var test = (ColorMock2)await _operations.DeserializeAsync(result);

    Assert.That(test.TestField, Is.EqualTo(color));
  }

  [SpeckleType("Speckle.Core.Tests.Unit.Api.Operations.ObjectSerialization+StringDateTimeRegressionMock2")]
  private class StringDateTimeRegressionMock2 : Base
  {
  ...
  {
    var mockBase = new StringDateTimeRegressionMock2 { TestField = "2021-11-12T11:32:01" };

    var result = _operations.Serialize2(mockBase);
    var test = (StringDateTimeRegressionMock2)await _operations.DeserializeAsync(result);
