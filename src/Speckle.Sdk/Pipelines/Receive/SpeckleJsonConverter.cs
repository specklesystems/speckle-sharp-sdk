...
public sealed class SpeckleJsonConverter(Dictionary<string, Base> map) : JsonConverter<Base>
{
  ...
  private object? ReadDynamicProperty(JsonElement element, JsonSerializerOptions options)
  {
    switch (element.ValueKind)
    {
      ...
      case JsonValueKind.Object:
        return ReadDynamicObjectAsync(element, options);
      case JsonValueKind.Array:
        return ReadReadDynamicArrayAsync(element, options);
