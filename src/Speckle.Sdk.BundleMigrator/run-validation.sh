#!/usr/bin/env bash
#
# run-validation.sh — fan the artefact-bundle migrator across a list of source models,
...
#   PARALLEL     max concurrent migrator runs (default 4)    — or --parallel
#
...
CSPROJ="$SCRIPT_DIR/Speckle.Sdk.BundleMigrator.csproj"
...
echo "Building migrator (Release) …"
