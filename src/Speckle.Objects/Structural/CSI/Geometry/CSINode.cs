  ...
  )
  {
    ...
    this.constraintAxis =
      ...
      ?? new Axis(
        ...
        new Plane
        {
          origin = new Point(0, 0, 0, units: Units.Meters),
          normal = new Vector(0, 0, 1, units: Units.Meters),
          xdir = new Vector(1, 0, 0, units: Units.Meters),
          ydir = new Vector(0, 1, 0, units: Units.Meters),
