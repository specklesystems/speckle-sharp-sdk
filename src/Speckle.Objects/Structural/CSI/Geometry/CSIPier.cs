...
[SpeckleType("Objects.Structural.CSI.Geometry.CSIPier")]
public class CSIPier : Base
{
  public CSIPier(
    ...
    double[] thicknessTop,
    string[] matProp,
    double[] centerofGravityBotX,
    double[] centerofGravityBotY,
    double[] centerofGravityBotZ,
    double[] centerofGravityTopX,
    double[] centerofGravityTopY,
    double[] centerofGravityTopZ
  )
  {
    this.name = name;
